...
export class NuevaFranjaComponent implements OnInit {
  ...
  comprobrarRegistradas():boolean{
    ...
    while(i<this.listaFranjas.length && valido==true){
      console.log('bucle')
      console.log(this.nuevaFranja.horaInicio)
      console.log(this.listaFranjas[i].horaInicio)
      console.log(this.nuevaFranja.horaFin)
      console.log(this.listaFranjas[i].horaFin)
